...
export default function RegisterPage() {
  ...
  return (
    <div className="card p-8 animate-slide-up">
      <h2 className="font-display font-semibold text-xl text-white mb-1">Create your account</h2>
      <p className="text-slate-500 text-sm mb-6">Start deploying in minutes</p>
